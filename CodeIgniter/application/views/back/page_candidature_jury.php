            ...
            if($candidature != NULL ) {
              // Boucle de parcours de toutes les lignes du résultat obtenu
                foreach($candidature as $uneCandidature){
                    if($uneCandidature["PTT_statutParticipant"] != 'N')
                    {
                        ?>
                        <tr>
                            ...
                            <td><a href = "<?php echo base_url();?>index.php/galerie/afficher/<?php echo $uneCandidature["PTT_idParticipant"];?>"><button type="button" class="btn btn-success">Afficher Galerie</button></a></td>
