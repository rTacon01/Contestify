...
<main id="main">
    ...
    <div class="breadcrumbs">
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              ...
              <p>Sur cette page vous y trouverez tous les concours présents dont vous êtes juré.</p>
            </div>
          </div>
        </div>
      </div>
      <nav>
        <div class="container">
          <ol>
            <li><a href="<?php echo base_url();?>index.php/compte/afficher_jury">Accueil</a></li>
    ...
    <section id = concours>
      <div class="container mt-3">
            <h2>  Tableau des concours selon le jury <?php echo $_SESSION['username'];?></h2>           
              ...
              // Boucle de parcours de toutes les lignes du résultat obtenu
                foreach($concours as $unConcours){
                    ...
                    <tr>
                        ...
                        <td><a href ="<?php echo base_url();?>index.php/candidature/afficher_all/<?php echo $unConcours["CCS_idConcours"];?>"><button type="button" class="btn btn-light btn-sm">Voir les candidatures</td></a></td><?php
                        }
                        else{
                            ?>
